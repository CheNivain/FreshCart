...
<%
  ...
  if (username != null) {
    try {
      ...
      PreparedStatement ps = conn.prepareStatement("SELECT first_name FROM customers WHERE username = ?");
  ...
  <div class="container nav-container">
    ...
    <nav>
      <ul class="nav-links">
        ...
        <li><a href="CustomerProducts.jsp">Products</a></li>
        <li><a href="about.jsp">About</a></li>
        <li><a href="contact.jsp">Contact</a></li>
        <li><a href="profile.jsp" class="editbtn">Profile</a></li>
      </ul>
    </nav>
  </div>
</header>
...
<div class="container hero-content">
  ...
  <p>Welcome back! Shop from your local vendors and get everything delivered fresh.</p>
  <a href="shoppingList.jsp" class="btn">Upload Shopping List</a>
</div>

<!-- Features -->
<section class="features">
  <div class="container feature-grid">
    <div class="feature-card"><a href="CustomerProducts.jsp">
    ...
    <div class="feature-card"><a href="CustomerfastDelivery.jsp">
    ...
    <div class="feature-card"><a href="CustomersecurePayments.jsp">
