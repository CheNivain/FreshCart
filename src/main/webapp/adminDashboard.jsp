...
<div class="main-content">
  ...
  <button class="btn btn-primary" onclick="openModal()">Add New Vendor</button>
    ...
    <div class="vendor-list-wrapper <%= vendorList.size() > 15 ? "scrollable-vendor-list" : "" %>">
      ...
      <div class="vendor-card" onclick="openEditModal('<%= vendor[2] %>', '<%= vendor[0] %>', '<%= vendor[3] %>')">
        <h4><%= vendor[1] %></h4>
        <p><strong>Employee ID:</strong> <%= vendor[2] %></p>
        <p><strong>Username:</strong> <%= vendor[0] %></p>
      </div>
      <% } %>
    </div>
    ...
    <div id="addVendorModal" class="modal" style="display: none">
      <div class="add-vendor-modal-content">
        ...
        <form action="vendorAddition" method="post" class="admin-register-form">
          ...
          <input type="text" id="EmployeeID" name="EmployeeID" class="add-vendor-input" placeholder="Enter your Employee ID" required>

          <!-- Admin Username -->
          <label for="username" class="add-vendor-label">Username</label>
          <input type="text" id="username" name="username" class="add-vendor-input" placeholder="Choose a username" required>

          <!-- Admin Password -->
          <label for="password" class="add-vendor-label">Password</label>
          <input type="password" id="password" name="password" class="add-vendor-input" placeholder="Enter password" required>

          <!-- Confirm Password -->
          <label for="confirm-password" class="add-vendor-label">Confirm Password</label>
          <input type="password" id="confirm-password" name="confirm-password" class="add-vendor-input" placeholder="Confirm password" required>
    ...
    <div id="editVendorModal" class="modal" style="display: none;">
      <div class="add-vendor-modal-content">
        ...
        <form action="editVendor" method="post" class="admin-register-form">
          ...
          <input type="text" id="editEmployeeID" name="EmployeeID" class="add-vendor-input" readonly placeholder="Employee ID">
          ...
          <div class="password-container">
            <input type="password" id="currentPassword" name="currentPassword" class="add-vendor-input" readonly placeholder="Current Password">
          ...
          <div class="password-container">
            <input type="password" id="editPassword" name="password" class="add-vendor-input" placeholder="Enter new password"
                   oninput="toggleEyeIcon('editPassword')" onfocus="handleInputFocus('editPassword')">
            <span class="eye-icon" onclick="togglePasswordVisibility('editPassword')" style="display: none;">👁️</span>
          </div>
          ...
          <button type="button" id="deleteEmployeeID" name="vendor_Id" class="add-vendor-cancel-btn delete-btn" onclick="openDeleteModal()" style="width: 100%">Delete Vendor</button>
    ...
    <div id="deleteVendorModal" class="modal" style="display: none;" >
      <div class="delete-vendor-modal-content">
        ...
        <form action="deleteVendor" method="post" class="admin-delete-form">
          ...
          <input type="password" id="adminPassword" name="adminPassword" class="add-vendor-input" placeholder="Enter your admin password" required>
  ...
  <section id="products" class="section">
    ...
    <div class="product-scroll-container">
      ...
      <div class="product-card" onclick="showProductDetails('<%= name %>', '<%= type %>', <%= stock %>, '<%= desc.replace("'", "\\'") %>', <%= price %>, '<%= image %>', '<%= productId%>>')">
