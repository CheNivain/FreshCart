    ...
    <div class="login-container">
        ...
        <form method="post" class="login-form">
            ...
            <select id="role" name="role" required>
                <option value="Freshcart Customer" <% if(request.getParameter("role") == null || !request.getParameter("role").equals("Freshcart DeliveryPerson")) { %>selected<% } %>>Freshcart Customer</option>
                <option value="Freshcart Delivery Person" <% if(request.getParameter("role") != null && request.getParameter("role").equals("Freshcart DeliveryPerson")) { %>selected<% } %>>Freshcart Delivery Person</option>
            </select>
